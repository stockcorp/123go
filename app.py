...
def index():
    ...
    if user:
        return redirect(url_for('freeindex'))
...
def freeindex():
    ...
    new_schedule_id = generate_schedule_id()
    return render_template('freeindex.html', user=user, schedules=schedules, collaborated=collaborated, new_schedule_id=new_schedule_id)
